<div class="modal fade text-left" data-bs-backdrop="static" id="editCity" tabindex="-1" role="dialog" aria-labelledby="editCityLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editCityLabel1"><span class="fa fa-user-edit"></span> Edit City</h5>
