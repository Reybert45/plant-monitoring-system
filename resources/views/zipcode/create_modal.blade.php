<div class="modal fade text-left" data-bs-backdrop="static" id="createZipCode" tabindex="-1" role="dialog" aria-labelledby="createZipCodeLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createZipCodeLabel1"><span class="fa fa-plus-circle"></span> Add New Zip Code</h5>
                                        ...
                                        <form id="createForm" class="form form-vertical">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="zipcode-icon">Zip Code</label>
                                                            <div class="position-relative">
