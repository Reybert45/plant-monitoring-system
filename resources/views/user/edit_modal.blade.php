<div class="modal fade text-left" data-bs-backdrop="static" id="editUser" tabindex="-1" role="dialog" aria-labelledby="editUserLabel1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUserLabel1"><span class="fa fa-user-edit"></span> Edit User</h5>
