<div class="modal fade text-left" data-bs-backdrop="static" id="createUser" tabindex="-1" role="dialog" aria-labelledby="createUserLabel1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createUserLabel1"><span class="fa fa-plus-circle"></span> Add New User</h5>
