<div class="modal fade text-left" data-bs-backdrop="static" id="editProvince" tabindex="-1" role="dialog" aria-labelledby="editProvinceLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editProvinceLabel1"><span class="fa fa-user-edit"></span> Edit Province</h5>
