<div class="modal fade text-left" data-bs-backdrop="static" id="editAdmin" tabindex="-1" role="dialog" aria-labelledby="editAdminLabel1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAdminLabel1"><span class="fa fa-user-edit"></span> Edit Admin</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="is-active-horizontal">Status<sup class="text-danger"><b>*</b></sup></label>
                                                            </div>
                                                            <div class="col-md-8 form-group">
                                                                <select name="is_active" id="is-active-horizontal" class="form-control">
                                                                    <option value="">--</option>
                                                                    <option value="1">Active</option>
                                                                    <option value="0">Inactive</option>
                                                                </select>
                                                                <span class="text-danger span-error is_active-error"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <select name="barangay_id" id="barangay-horizontal" class="form-control">
                                                                        ...
                                                                        @foreach ($address_status->barangays_list as $barangay)
                                                                            <option value="{{ $barangay->id }}" data-street_id="{{ $barangay->street_id }}">{{ $barangay->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <select name="region_id" id="region-horizontal" class="form-control">
                                                                        ...
                                                                        @foreach ($address_status->regions_list as $region)
                                                                            <option value="{{ $region->id }}" data-barangay_id="{{ $region->barangay_id }}">{{ $region->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <select name="city_id" id="city-horizontal" class="form-control">
                                                                        ...
                                                                        @foreach ($address_status->cities_list as $city)
                                                                            <option value="{{ $city->id }}" data-region_id="{{ $city->region_id }}">{{ $city->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <select name="province_id" id="province-horizontal" class="form-control">
                                                                        ...
                                                                        @foreach ($address_status->provinces_list as $province)
                                                                            <option value="{{ $province->id }}" data-city_id="{{ $province->city_id }}">{{ $province->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <select name="zipcode_id" id="zipcode-horizontal" class="form-control">
                                                                        ...
                                                                        @foreach ($address_status->zipcodes_list as $zipcode)
                                                                            <option value="{{ $zipcode->id }}" data-province_id="{{ $zipcode->province_id }}">{{ $zipcode->name }}</option>
                                                                        @endforeach
                                                                    </select>
