<div class="modal fade text-left" data-bs-backdrop="static" id="editGender" tabindex="-1" role="dialog" aria-labelledby="editGenderLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editGenderLabel1"><span class="fa fa-user-edit"></span> Edit Gender</h5>
