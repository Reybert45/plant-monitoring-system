...
<script type="text/javascript">
    function generatePDF(btn) {
        var url = "{{ url('user/report/generatePDF') }}?date_from="+btn.data('date_from')+"&date_to="+btn.data('date_to');
        window.open(url, "_blank");
    }
    function generateExcel(btn) {
        var url = "{{ url('user/report/generateExcel') }}?date_from="+btn.data('date_from')+"&date_to="+btn.data('date_to');
        window.open(url, "_blank");
    }
</script>
