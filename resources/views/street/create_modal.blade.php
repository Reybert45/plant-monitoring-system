<div class="modal fade text-left" data-bs-backdrop="static" id="createStreet" tabindex="-1" role="dialog" aria-labelledby="createStreetLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createStreetLabel1"><span class="fa fa-plus-circle"></span> Add New Street</h5>
