...
{
    $.get("../admin/data").then(function(data) {
...
$("#data-container").on("click", ".delete-btn", function() {
    ...
    $.post("../admin/delete?_token="+ token + "&id=" + id).then(function(res) {
        iziToastAlert(res, btn, html);
    });
});
...
$("#editAdmin").on("shown.bs.modal", function(e) {
    ...
    let admin = JSON.parse(atob(btn.data('admin')));
    
    $("#editForm").trigger("reset");
    $("#edit-btn").attr("data-id", btn.data('id'));
    $("#editForm").find("input[name='username']").val(admin.username);
    $("#editForm").find("input[name='email']").val(admin.email);
    $("#editForm").find("input[name='first_name']").val(admin.first_name);
    $("#editForm").find("input[name='middle_name']").val(admin.middle_name);
    $("#editForm").find("input[name='last_name']").val(admin.last_name);
    $("#editForm").find("input[name='birthdate']").val(admin.birthdate);
    $("#editForm").find("select[name='suffix_id']").val(admin.suffix_id);
    $("#editForm").find("select[name='gender_id']").val(admin.gender_id);
    $("#editForm").find("select[name='is_active']").val(admin.is_active);
    $("#editForm").find("#current_address select[name='street_id']").val(admin.current_address_street_id);
    $("#editForm").find("#current_address select[name='barangay_id']").val(admin.current_address_barangay_id);
    $("#editForm").find("#current_address select[name='region_id']").val(admin.current_address_region_id);
    $("#editForm").find("#current_address select[name='city_id']").val(admin.current_address_city_id);
    $("#editForm").find("#current_address select[name='province_id']").val(admin.current_address_province_id);
    $("#editForm").find("#current_address select[name='zipcode_id']").val(admin.current_address_zipcode_id);

    $("#editForm").find("#permanent_address select[name='street_id']").val(admin.permanent_address_street_id);
    $("#editForm").find("#permanent_address select[name='barangay_id']").val(admin.permanent_address_barangay_id);
    $("#editForm").find("#permanent_address select[name='region_id']").val(admin.permanent_address_region_id);
    $("#editForm").find("#permanent_address select[name='city_id']").val(admin.permanent_address_city_id);
    $("#editForm").find("#permanent_address select[name='province_id']").val(admin.permanent_address_province_id);
    $("#editForm").find("#permanent_address select[name='zipcode_id']").val(admin.permanent_address_zipcode_id);
});
